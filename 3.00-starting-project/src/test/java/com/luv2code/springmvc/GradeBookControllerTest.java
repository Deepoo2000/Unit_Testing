...
public class GradeBookControllerTest {
    ...
    @Test
    public void deleteStudentRequestErrorPage() throws Exception{
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders
    ...
    @Test
    public void createAValidGradeHttpRequestStudentDoesNotExistResponse() throws Exception{
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade","85.55")
    ...
    @Test
    public void createANonValidGradeHttpRequestGradeTypeDoesNotExistResponse() throws Exception{
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                        .contentType(MediaType.APPLICATION_JSON)
                        .param("grade","85.55")
    ...
    @Test
    public void deleteAValidHttpRequest()throws Exception{
