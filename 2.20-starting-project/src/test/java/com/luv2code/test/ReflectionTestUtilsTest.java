...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach(){
        ...
        ReflectionTestUtils.setField(studentOne, "studentGrades",
                new StudentGrades(new ArrayList<>(Arrays.asList(100.00, 85.0, 76.50, 91.75))));
    }
    ...
    public void invokePrivateMethod(){
        assertEquals("Eric 1", ReflectionTestUtils
                .invokeMethod(studentOne, "getFirstNameAndId"), "Fail Private Method Not Call");
    }
